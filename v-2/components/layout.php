...
function v2_render_sidebar(string $active, string $baseUrl, string $baseRoot): void
{
    ...
    echo '<aside class="v2-sidebar" id="v2Sidebar"><div class="v2-brand"><span class="v2-brand-mark">M</span><div><strong>MONBIS</strong><small>Business Intelligence</small></div><button type="button" class="v2-icon-button v2-sidebar-close" data-v2-sidebar-close aria-label="Tutup menu">' . v2_icon('close', 18) . '</button></div>';
    echo '<nav class="v2-nav" aria-label="Navigasi v2">';
    echo '<a class="v2-nav-item' . $is('dashboard') . '" href="' . v2_e($link('dashboard')) . '">' . v2_icon('home') . '<span>Dashboard</span></a>';
    ...
    echo '<div class="v2-nav-group"><button type="button" class="v2-nav-group-title" data-v2-nav-group><span>' . v2_icon('settings') . '<span>Sistem</span></span>' . v2_icon('chevron', 15) . '</button><div class="v2-nav-sub"><a class="v2-nav-sub-item' . $is('components') . '" href="' . v2_e($link('components')) . '">UI Kit</a><a class="v2-nav-sub-item' . $is('settings') . '" href="' . v2_e($link('settings')) . '">Pengaturan</a><a class="v2-nav-sub-item" href="' . v2_e($baseRoot . '/admin') . '">Administrasi Lama</a></div></div>';
    echo '</nav><div class="v2-sidebar-footer"><span class="v2-status-dot"></span><span>FE v2 sedang disiapkan</span></div></aside>';
}
