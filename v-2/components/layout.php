...
function v2_render_sidebar(string $active, string $baseUrl, string $baseRoot): void
{
    ...
    echo '<a class="v2-nav-item" href="' . v2_e($baseRoot . '/admin') . '">' . v2_icon('settings') . '<span>Administrasi</span></a>';
...
{
    echo '<script src="assets/js/app.js?v=1" defer></script></body></html>';
}
