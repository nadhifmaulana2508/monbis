...
function v2_render_sidebar(string $active, string $baseUrl, string $legacyBase = ''): void
{
    ...
    echo '<div class="v2-nav-group" data-v2-access="kpi"><button type="button" class="v2-nav-group-title" data-v2-nav-group title="KPI Bisnis"><span>' . v2_icon('chart') . '<span>KPI Bisnis</span></span>' . v2_icon('chevron', 15) . '</button><div class="v2-nav-sub">';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('setting_kpi_jabatan')) . '" title="Setting KPI Jabatan">Setting KPI Jabatan</a>';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('hitung_kpi_ao')) . '" title="Nilai KPI AO">Nilai KPI AO</a>';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('generate_kpi_ao')) . '" title="Generate KPI AO">Generate KPI AO</a>';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('rekap_kpi_ao')) . '" title="Rekap KPI AO">Rekap KPI AO</a>';
    echo '</div></div>';
    echo '<div class="v2-nav-group" data-v2-access="rbb"><button type="button" class="v2-nav-group-title" data-v2-nav-group title="Input RBB"><span>' . v2_icon('file') . '<span>Input RBB</span></span>' . v2_icon('chevron', 15) . '</button><div class="v2-nav-sub">';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('input_rbb')) . '" title="Proyeksi RBB">Proyeksi RBB</a>';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('input_rbb_aba')) . '" title="Input RBB ABA">Input RBB ABA</a>';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('input_rbb_detail?bagian=kredit')) . '" title="Input RBB Kredit">Input RBB Kredit</a>';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('input_rbb_detail?bagian=damas')) . '" title="Input RBB DAMAS">Input RBB DAMAS</a>';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('input_rbb_detail?bagian=pendapatan')) . '" title="Input RBB Pendapatan">Input RBB Pendapatan</a>';
    echo '<a class="v2-nav-sub-item" href="' . v2_e($legacyLink('input_rbb_detail?bagian=beban')) . '" title="Input RBB Beban">Input RBB Beban</a>';
    echo '</div></div>';
