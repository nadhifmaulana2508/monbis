...
$allowedPages = ['launcher', 'components', 'collection', 'templates', 'settings'];
if (!in_array($page, $allowedPages, true)) {
    $page = 'launcher';
}

$legacyBase = rtrim(str_replace('\\', '/', dirname($baseUrl)), '/');
$pageTitles = ['launcher' => 'MONBIS Workspace', 'components' => 'FE Component Library', 'collection' => 'Report NPL', 'templates' => 'Page Templates', 'settings' => 'Workspace Settings'];
