...
require_once __DIR__ . '/generate-confirm.php';
...
if (!function_exists('mb_ui_assets')) {
    ...
    {
        $base = rtrim($base, '/');
        echo '<link rel="stylesheet" href="' . mb_e($base . '/assets/css/monbis-components.css') . '?v=72">' . PHP_EOL;
        echo '<script src="' . mb_e($base . '/assets/js/monbis-components.js') . '?v=20" defer></script>' . PHP_EOL;
    }
}
