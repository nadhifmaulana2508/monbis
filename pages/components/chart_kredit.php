<div class="grid grid-cols-1 lg:grid-cols-5 gap-4">
  ...
  <div class="bg-white p-4 md:p-5 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 lg:col-span-3 flex flex-col">
    <div class="flex flex-col md:flex-row justify-between md:items-center gap-3 md:gap-0 mb-2 border-b border-gray-100 pb-3">
      ...
      <div class="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
        <select id="filter_tren_tipe" class="border border-gray-200 rounded-md px-3 py-1.5 text-xs font-semibold text-gray-600 outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer bg-white shadow-sm w-full sm:w-auto">
            <option value="nom">Nominal (Rp)</option>
            <option value="pct">Persentase (%)</option>
            <option value="npl" selected>NPL</option>
        </select>
        <select id="filter_tren" class="border border-gray-200 rounded-md px-3 py-1.5 text-xs font-semibold text-gray-600 outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer bg-white shadow-sm w-full sm:w-auto">
