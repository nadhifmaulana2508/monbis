<div class="tv-fit grid lg:grid-cols-12 gap-3 md:gap-4">
    <div class="lg:col-span-5 grid grid-rows-2 gap-3 md:gap-4 min-h-0">
        <div class="tv-card bg-white p-3 md:p-4 rounded-xl md:rounded-3xl shadow-sm border border-gray-100 flex flex-col">
            <div class="flex items-center justify-between gap-3 border-b border-gray-100 pb-2 mb-2 shrink-0">
                ...
                <div id="summary_runoff_growth" class="text-right text-[10px] md:text-xs font-bold text-gray-500 shrink-0">
                    Growth: <span class="text-gray-900">Rp 0</span>
                </div>
            </div>
        ...
        <div class="tv-card bg-white p-3 md:p-4 rounded-xl md:rounded-3xl shadow-sm border border-gray-100 flex flex-col">
            <div class="flex items-center justify-between gap-3 border-b border-gray-100 pb-2 mb-2 shrink-0">
                ...
                <div id="summary_flow_os_npl" class="text-right text-[10px] md:text-xs font-bold text-gray-500 shrink-0">
                    OS NPL: <span class="text-gray-900">Rp 0</span>
                </div>
            </div>
    ...
    <div class="tv-card bg-white p-4 md:p-6 rounded-xl md:rounded-3xl shadow-sm border border-gray-100 lg:col-span-7 relative flex flex-col">
        ...
        <div class="flex flex-col xl:flex-row xl:items-center justify-between mb-3 md:mb-4 border-b border-gray-100 pb-2 md:pb-3 shrink-0 gap-3">
            <div>
                <h3 class="font-bold text-gray-800 flex items-center gap-2 text-[14px] md:text-2xl">
