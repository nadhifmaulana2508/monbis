<div class="tv-fit tv-compact-gap tv-makro-slide flex flex-col gap-3 md:gap-4">
    <div class="tv-makro-kpi-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2.5 md:gap-3 shrink-0">
        <div class="tv-card tv-makro-kpi bg-white p-3 md:p-3.5 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden col-span-2 md:col-span-1">
            <div class="absolute top-0 left-0 w-1.5 h-full bg-blue-500 rounded-l-2xl"></div>
            <p class="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-0.5 truncate">Total Baki Debet (OS)</p>
            <h3 id="kpi_os" class="text-lg md:text-xl xl:text-2xl font-black text-gray-900 tracking-tight whitespace-nowrap mb-1">Rp 0</h3>
            <div id="kpi_os_pill"></div>
        </div>
        <div class="tv-card tv-makro-kpi bg-white p-3 md:p-3.5 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden col-span-1">
            <div class="absolute top-0 left-0 w-1.5 h-full bg-cyan-500 rounded-l-2xl"></div>
            <p class="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-0.5 truncate">Saldo Bank</p>
            <h3 id="kpi_saldobank" class="text-lg md:text-xl xl:text-2xl font-black text-cyan-600 tracking-tight whitespace-nowrap mb-1">Rp 0</h3>
            <div id="kpi_saldobank_pill"></div>
        </div>
        <div class="tv-card tv-makro-kpi bg-white p-3 md:p-3.5 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden col-span-1">
            <div class="absolute top-0 left-0 w-1.5 h-full bg-red-500 rounded-l-2xl"></div>
            <p class="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-0.5 truncate">Total OSC NPL</p>
            <h3 id="kpi_npl" class="text-lg md:text-xl xl:text-2xl font-black text-red-600 tracking-tight whitespace-nowrap mb-1">Rp 0</h3>
            <div id="kpi_npl_pill"></div>
        </div>
        <div class="tv-card tv-makro-kpi bg-white p-3 md:p-3.5 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden col-span-1">
            <div class="absolute top-0 left-0 w-1.5 h-full bg-green-500 rounded-l-2xl"></div>
            <p class="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-0.5 truncate">Repayment Rate (RR)</p>
            <h3 id="kpi_rr" class="text-lg md:text-xl xl:text-2xl font-black text-green-600 tracking-tight whitespace-nowrap mb-1">Rp 0</h3>
            <div id="kpi_rr_pill"></div>
        </div>
        <div class="tv-card tv-makro-kpi bg-white p-3 md:p-3.5 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden col-span-1 md:col-span-1">
            <div class="absolute top-0 left-0 w-1.5 h-full bg-purple-500 rounded-l-2xl"></div>
            <p class="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-0.5 truncate">Total DPK (Actual)</p>
            <h3 id="kpi_dpk" class="text-lg md:text-xl xl:text-2xl font-black text-purple-700 tracking-tight whitespace-nowrap mb-1">Rp 0</h3>
            <div id="kpi_dpk_pill"></div>
        </div>
    </div>

    <div class="tv-makro-main-grid grid lg:grid-cols-12 gap-2.5 md:gap-3 flex-grow min-h-0">
        <div class="tv-card tv-makro-panel bg-white p-3 md:p-4 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 lg:col-span-3 flex flex-col">
            <h3 class="font-bold text-gray-800 flex items-center gap-1.5 md:gap-2 mb-2.5 border-b border-gray-100 pb-2 text-[12px] md:text-sm"><span class="text-indigo-500">Bank</span> Ringkasan Keuangan (Actual)</h3>
            <div class="tv-list tv-makro-summary-list space-y-2">
                <div id="makro_aset" class="tv-makro-summary-item flex justify-between items-center bg-gray-50 p-2 rounded-lg border border-gray-100">
                ...
                <div id="makro_laba" class="tv-makro-summary-item flex justify-between items-center bg-gray-50 p-2 rounded-lg border border-gray-100">
                ...
                <div id="makro_pendapatan" class="tv-makro-summary-item flex justify-between items-center bg-gray-50 p-2 rounded-lg border border-gray-100">
                ...
                <div id="makro_biaya" class="tv-makro-summary-item flex justify-between items-center bg-gray-50 p-2 rounded-lg border border-gray-100">
        ...
        <div class="tv-card tv-makro-panel bg-white p-3 md:p-4 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 lg:col-span-3 flex flex-col">
            <h3 class="font-bold text-gray-800 flex items-center gap-1.5 md:gap-2 mb-2.5 border-b border-gray-100 pb-2 text-[12px] md:text-sm"><span class="text-red-500">Biaya</span> Top 5 Beban Biaya (Actual)</h3>
