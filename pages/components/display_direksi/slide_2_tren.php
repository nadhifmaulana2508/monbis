<div class="tv-fit flex flex-col">
    <div class="tv-card bg-white p-3 md:p-4 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
        <div class="flex flex-col gap-2.5 md:gap-3 mb-3 border-b border-gray-100 pb-3 shrink-0">
            <div class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <p class="text-[10px] md:text-xs text-gray-500 font-medium mt-1">Histori mingguan mengikuti bulan pada harian date yang dipilih</p>
                </div>
                <div class="bg-amber-50 border border-amber-100 rounded-xl px-3 py-2 flex items-center justify-between gap-3 min-w-[250px] shrink-0 w-full md:w-auto">
                    <div class="min-w-0">
            ...
            <div class="grid grid-cols-2 xl:grid-cols-4 gap-2.5">
                <div class="rounded-xl border border-sky-100 bg-sky-50 p-2.5">
                ...
                <div class="rounded-xl border border-violet-100 bg-violet-50 p-2.5">
        ...
        <div class="relative flex-grow min-h-0">
            ...
            <div class="grid md:grid-cols-2 gap-3 h-full">
                <div class="tv-card border border-sky-100 rounded-xl p-3 bg-sky-50 shadow-sm flex flex-col min-h-0">
                ...
                <div class="tv-card border border-emerald-100 rounded-xl p-3 bg-emerald-50 shadow-sm flex flex-col min-h-0">
                    <div class="flex items-start justify-between gap-3 mb-1.5 shrink-0">
                        <div>
                ...
                <div class="tv-card border border-violet-100 rounded-xl p-3 bg-violet-50 shadow-sm flex flex-col min-h-0">
                    <div class="flex items-start justify-between gap-3 mb-1.5 shrink-0">
                        <div>
                ...
                <div class="tv-card border border-amber-100 rounded-xl p-3 bg-amber-50 shadow-sm flex flex-col min-h-0">
                    <div class="flex items-start justify-between gap-3 mb-1.5 shrink-0">
                        <div>
